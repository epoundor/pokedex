...
export function apiCall<T, PayloadType = any>(
  ...
  async function execute(config?: Partial<Option<PayloadType>>): Promise<void> {
    ...
    console.log("config.routeParams:", config?.routeParams);

    console.log("routeParamsKeys:", routeParamsKeys);
    ...
    console.log("stringifiedRouteParams:", stringifiedRouteParams);
    ...
    console.log("======= [TEST] requestConfig:", requestConfig);
